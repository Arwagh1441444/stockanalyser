...
class RefreshEngine:
    ...
    def refresh(self, sample_limit: Optional[int] = DEFAULT_SAMPLE_LIMIT, news_limit: int = DEFAULT_NEWS_LIMIT, refresh_universe: str = "ALL") -> None:
        ...
        config_df = self._default_config(total_universe=total_universe, active_symbols=len(active_universe), news_limit=int(news_limit or 0), refresh_universe=refresh_universe)
