...
"""
Backup universe lists for the Excel-first market engine.

Source note:
- NIFTY 500 / NIFTY 50 / NIFTY BANK backup lists were generated from the official
  Nifty Indices constituent CSV files downloaded on 2026-04-05.
- PSU list is a maintained manual basket and can be edited safely.
"""
